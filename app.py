...
# 6. AI 생성 프롬프트 (글자 수 한글 130자 지정 강화)
def generate_log(data):
    ...
    2. 본문 글자 수 조건: **각 시간대별 본문 문단은 공백 포함 한글 130자 내외(120자~140자 사이)**로 작성하세요. 너무 짧거나 너무 길지 않게 핵심 내용과 배운 점을 균형 있게 다듬으세요.
    3. 본문 문단 내용: [내가 직접 한 일 ➔ 현장 관찰 사항/어르신 반응 ➔ 이를 통해 배운 솔직한 점]을 자연스러운 2~3문장으로 구성하세요.
    4. 실습생의견 글자 수 조건: **'실습생의견' 문단 역시 공백 포함 한글 130자 내외(120자~140자 사이)**로 작성하세요.
    5. 실습생의견 내용: [오늘 인상 깊었던 일 ➔ 깨달은 배움 ➔ 아쉬운 점 및 다음 실습 다짐]을 담아 정성스러운 1개의 문단으로 작성하세요.
    6. 어조: 솔직하고 진정성 있는 '실습생 어조'(~하였다, ~를 알게 되었다, ~를 배웠다)를 유지하세요.
...
if st.button("🚀 실습일지 문장 생성하기", type="primary"):
    if not activities_data:
        ...
        with st.spinner("한글 130자 내외의 정갈한 문장으로 완성하는 중입니다..."):
            try:
